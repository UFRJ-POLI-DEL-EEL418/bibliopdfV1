...
<html>
    ...
    <body>
        <div id="idDivCabecalho">
            <div id="menuEntrarXXX"  class="Menu">
                ENTRAR
            </div>
        ...
        <div id="idDivLogin">
            ...
            <form id="idForm" method="POST" action="j_security_check">
                Usuário
                <br>
                <input id="idUsuario" type="text" name="j_username" disabled><br>
                Senha
                <br>
                <input id="idSenha" type="password" name="j_password" disabled>
            </form>
            <br>
            <div style="text-align:center;font-size:16pt;color:black">
            ...
            <br>
            tente de novo 
            <a href="/bibliopdf/protegido/busca_catalogacao.jsp" style="color:blue;">
                aqui
            </a>.
            </div>
            <br>
